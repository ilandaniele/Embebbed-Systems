...
#include "D:\Usuario\Escritorio\Sistemas Embebidos\Laboratorio 2\Actividad 3\adc_driver.cpp"
...
void mi_callback(){ //esta fncion de callback especifica para el LDR nos convierte el valor
  float Vi= mapfloat(adc.adc_value,0,1023,0,5);
...
void loop() {  
 //ACTUALIZAR LCD CON LOS VALORES DE LUX
  lcd.setCursor(5, 1); 
  lcd.print(Lux);  
  adc_loop(); 
}
